...
import styles from "../Styling/Theater.module.css";
...
export const Header = () => {
  ...
  const movie = useSelector((store)=>store.book.bookedMovie)
  ...
  const isError = useSelector(state => state.book.isError);
    ...
    return movie === undefined ? <div>Loading...</div> : isLoading ? <div text-align="center">Loading...</div> : isError ? <div>Something wrong happened</div> :(
      <div className={styles.header__container}>
          <div className={styles.header_container__info}>
              ...
              <div>
                  ...
                  { movie.rating?<div className={styles.header_container__info__rating}>
