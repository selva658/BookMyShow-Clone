...
import "../Components/Styling/Movies.model.css";
...
const SeeAll = () => {
  ...
  const [filterFormate, setFilterFormate] = useState([]);
  ...
  const filterMovies = () => {
    ...
    if (filterFormate.length > 0) {
      const updated = movie.filter(
        (item) =>
          item.screen_type?.find((formate) =>
            formate.type === filterFormate[filterFormate.length - 1]
              ? formate.type
              : formate.type
          ).type === filterFormate[filterFormate.length - 1]
      );
      setMovie(updated);
    }
    if (
    ...
    <div className={"container"}>
      <div className={"leftsideNav"}>
            ...
            <button
              style={
                filterLanguage.includes("Hindi")
                  ? { background: "#e67088", border: "none", color: "white" }
                  : {}
              }
        ...
        <div>
          ...
          <div
            className={"dialogue"}
            style={formate ? { display: "flex" } : { display: "none" }}
          >
            <button
              style={
                filterFormate.includes("2D")
                  ? { background: "#e67088", border: "none", color: "white" }
                  : {}
              }
              onClick={() => handleFilter("", "", "2D")}
            >
              2D
            </button>
            <button
              style={
                filterFormate.includes("4D")
                  ? { background: "#e67088", border: "none", color: "white" }
                  : {}
              }
              onClick={() => handleFilter("", "", "4D")}
            >
              4D
            </button>
            <button
              style={
                filterFormate.includes("4DX")
                  ? { background: "#e67088", border: "none", color: "white" }
                  : {}
              }
              onClick={() => handleFilter("", "", "4DX")}
            >
              4DX
            </button>
            <button
              style={
                filterFormate.includes("IMAX 2D")
                  ? { background: "#e67088", border: "none", color: "white" }
                  : {}
              }
              onClick={() => handleFilter("", "", "IMAX 2D")}
            >
              IMAX 2D
            </button>
            <button
              style={
                filterFormate.includes("IMAX 3D")
                  ? { background: "#e67088", border: "none", color: "white" }
                  : {}
              }
              onClick={() => handleFilter("", "", "IMAX 3D")}
            >
              IMAX 3D
            </button>
          </div>
      ...
      <div>
        ...
        <div className={"explore"}>
          ...
          <div style={{ color: "#e67088", fontSize: "18px" }}>
            {"Explore Upcomming movies >"}
          </div>
        </div>
